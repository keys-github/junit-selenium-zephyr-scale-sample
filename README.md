# Run JUnit Selenium Tests with Zephyr Scale on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Java JUnit tests with Selenium integrated with Zephyr Scale for test management. This sample shows how to configure JUnit + Selenium + Zephyr Scale to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/junit-selenium-zephyr-scale-sample && cd junit-selenium-zephyr-scale-sample
